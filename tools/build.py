...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("UN_Aurora_Lite-0.1.4-Sulkan-0.4.2.zip"))
    ...
    with zipfile.ZipFile(output, "w", zipfile.ZIP_DEFLATED, compresslevel=9) as archive:
        for path in files:
            info = zipfile.ZipInfo(path.relative_to(root).as_posix(), (2026, 9, 17, 0, 0, 0))
